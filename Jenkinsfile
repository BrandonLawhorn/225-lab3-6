pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/lawhorb'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/BrandonLawhorn/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('lawhorb-225')                                                         //<------change this
    }
